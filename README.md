...
| **MiniMax M3**              | MiniMax   | No                     | ✅               | [Extension (PAYG, source build)](https://github.com/tugudush/minimax-copilot) ★ / [Manual setup](docs/models/minimax.md)                         |
| **MiniMax M3 Priority**     | MiniMax   | No                     | ✅               | [Extension (PAYG, source build)](https://github.com/tugudush/minimax-copilot) ★ / [Manual setup](docs/models/minimax.md#m3-priority-tier)        |
