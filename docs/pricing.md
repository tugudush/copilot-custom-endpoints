...
All models are listed together below, sorted by estimated session cost (cheapest first). Session cost assumes ~10K input + ~2K output tokens per turn, 50 turns.
